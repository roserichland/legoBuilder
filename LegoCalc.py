...
def lego_piece_length():
    ...
    while True:
        try:
            ...
            print(
                "Remember we are trying to find the dimensions of the lego and we are using numbers. Put in how many units long it is:")
    ...
    while True:
        try:
            ...
            if which_struct == 2:
                ...
                options = input(
                    "You need to choose 1 or 2 to choose a structure. Would you like to try a different structure instead? (yes or no)\n")
            ...
            print(
                "We are trying to determine the structure you want to build. Use the numbers that correspond to the shape.")
...
def find_floor(lego_length):
    ...
    while some_num == True:
        try:
            ...
            dimensions_length = int(input("How long do you want your wall?"))
            some_num = False
        except:
    ...
    print("That means that you will need ", ((dimensions_wide * dimensions_length) / (lego_length * lego_width)),
          "legos ")
